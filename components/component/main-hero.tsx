    ...
    <section className="w-full">
      <div className="container px-4 md:px-6 flex flex-col items-start gap-2">
        ...
        <div className="flex items-center">
          <Link
            className="inline-flex w-100 items-center rounded-full shadow-blue-200/50 shadow-lg hover:shadow-xl bg-sky-100 hover:bg-sky-200	 dark:bg-slate-800 text-slate-800	 text-sm font-normal px-2 py-1 ml-2"
            href="./login"
            style={{
              borderRadius: "50px",
            }}
